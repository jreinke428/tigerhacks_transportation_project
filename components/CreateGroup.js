...
export default function CreateGroup({navigation}) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View
        style={[styles.ineomorphTop, {marginHorizontal: '25%'}]}>
      ...
      <TouchableOpacity style={[styles.neomorphTop, {marginHorizontal: '25%'}, {marginTop: '30%'}]}>
        <TouchableOpacity style={styles.neomorphBottom}>
          <TouchableOpacity style={styles.neomorphInner}>
            <Button
              title={area.length ? 'Edit Area' : 'Create Area'}
              onPress={() => navigation.navigate('Area', {area, setArea})}
              color="white"
            />
          </TouchableOpacity>
        </TouchableOpacity>
